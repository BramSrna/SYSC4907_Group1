...
const keyboardVerticalOffset =
   Platform.OS === "ios" ? Header.HEIGHT + 64 : Header.HEIGHT + 0;
      ...
      return (
         <View style={styles.container}>
               ...
               <View style={styles.rowSorter}>
                  ...
                  <View style={{ flex: 1 }}>
                     ...
                     >
                        ...
                        />
                        <Picker.Item
                           label="Flowers and Floral Arrangements"
                           value="FLOWERS_AND_FLORAL_ARRANGEMENTS"
                        />
                        <Picker.Item label="Grocery" value="GROCERY" />
                        <Picker.Item
                           label="Meat and Poultry"
                           value="MEAT_AND_POULTRY"
                        />
                        <Picker.Item
            ...
            <View style={styles.botContainer}>
               <TouchableHighlight
                  style={[
                     globalStyles.defaultButtonContainer,
